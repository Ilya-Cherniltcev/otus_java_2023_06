...
class CustomerTest {
    ...
    void customerAsKeyTest() {
        ...
        //when
        long newScore = customer.getScores() + 10; // -- вернулось 233 + 10 = 243
    ...
    void scoreSortingTest() {
        ...
        // сопоставление ключ-значение сравнивается с наименьшим ключом, строго превышающим заданный ключ, или null, если такого ключа нет
